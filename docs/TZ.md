...
| **Til** | O'zbek tili, Rus tili |
| **Backend** | Laravel 12 + MySQL + Sanctum ([savdodaftar-backend](https://gitlab.com/savdodaftar-group1/savdodaftar-backend)) |

UI/UX ekranlari va design system bo'yicha batafsil spetsifikatsiya: [README.md](../README.md).

> **Holat:** TZ v3 **to'liq** — 1–37 bo'limlar.
...
- **Pro versiya** taklifi bildirishnoma blokidan oldin alohida bannerda ko'rsatiladi (bat. 36-bo'lim).
...
1. Foydalanuvchi telefon raqamini kiritadi (**E.164 format:** `+998XXXXXXXXX`).
2. Backend API **Eskiz.uz** orqali bir martalik SMS kod (OTP) yuboradi.
3. Foydalanuvchi kodni kiritadi → backend tasdiqlaydi → ism, savdo turi, do'kon/bozor nomi so'raladi → **PIN kod** o'rnatiladi.
4. Keyingi kirishlarda faqat **PIN yoki biometrika** so'raladi; SMS faqat birinchi ro'yxatdan o'tish va parol/PIN tiklashda ishlatiladi.
